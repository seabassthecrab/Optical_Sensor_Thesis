...
leap_hand__srv__LeapPosition_Request__create()
{
  ...
  leap_hand__srv__LeapPosition_Request * msg = (leap_hand__srv__LeapPosition_Request *)allocator.allocate(sizeof(leap_hand__srv__LeapPosition_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(leap_hand__srv__LeapPosition_Request));
  bool success = leap_hand__srv__LeapPosition_Request__init(msg);
  if (!success) {
...
leap_hand__srv__LeapPosition_Request__destroy(leap_hand__srv__LeapPosition_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    leap_hand__srv__LeapPosition_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
leap_hand__srv__LeapPosition_Request__Sequence__init(leap_hand__srv__LeapPosition_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leap_hand__srv__LeapPosition_Request * data = NULL;

  if (size) {
    data = (leap_hand__srv__LeapPosition_Request *)allocator.zero_allocate(size, sizeof(leap_hand__srv__LeapPosition_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = leap_hand__srv__LeapPosition_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        leap_hand__srv__LeapPosition_Request__fini(&data[i - 1]);
      }
...
leap_hand__srv__LeapPosition_Request__Sequence__fini(leap_hand__srv__LeapPosition_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      leap_hand__srv__LeapPosition_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leap_hand__srv__LeapPosition_Request__Sequence * array = (leap_hand__srv__LeapPosition_Request__Sequence *)allocator.allocate(sizeof(leap_hand__srv__LeapPosition_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = leap_hand__srv__LeapPosition_Request__Sequence__init(array, size);
  if (!success) {
...
leap_hand__srv__LeapPosition_Request__Sequence__destroy(leap_hand__srv__LeapPosition_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    leap_hand__srv__LeapPosition_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
leap_hand__srv__LeapPosition_Request__Sequence__are_equal(const leap_hand__srv__LeapPosition_Request__Sequence * lhs, const leap_hand__srv__LeapPosition_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!leap_hand__srv__LeapPosition_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  leap_hand__srv__LeapPosition_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(leap_hand__srv__LeapPosition_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    leap_hand__srv__LeapPosition_Request * data =
      (leap_hand__srv__LeapPosition_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!leap_hand__srv__LeapPosition_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          leap_hand__srv__LeapPosition_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!leap_hand__srv__LeapPosition_Request__copy(
...
leap_hand__srv__LeapPosition_Response__init(leap_hand__srv__LeapPosition_Response * msg)
{
  ...
  if (!rosidl_runtime_c__double__Sequence__init(&msg->position, 0)) {
    leap_hand__srv__LeapPosition_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leap_hand__srv__LeapPosition_Response * msg = (leap_hand__srv__LeapPosition_Response *)allocator.allocate(sizeof(leap_hand__srv__LeapPosition_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(leap_hand__srv__LeapPosition_Response));
  bool success = leap_hand__srv__LeapPosition_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
leap_hand__srv__LeapPosition_Response__Sequence__init(leap_hand__srv__LeapPosition_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leap_hand__srv__LeapPosition_Response * data = NULL;

  if (size) {
    data = (leap_hand__srv__LeapPosition_Response *)allocator.zero_allocate(size, sizeof(leap_hand__srv__LeapPosition_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = leap_hand__srv__LeapPosition_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        leap_hand__srv__LeapPosition_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
leap_hand__srv__LeapPosition_Response__Sequence__fini(leap_hand__srv__LeapPosition_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      leap_hand__srv__LeapPosition_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leap_hand__srv__LeapPosition_Response__Sequence * array = (leap_hand__srv__LeapPosition_Response__Sequence *)allocator.allocate(sizeof(leap_hand__srv__LeapPosition_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = leap_hand__srv__LeapPosition_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
leap_hand__srv__LeapPosition_Response__Sequence__destroy(leap_hand__srv__LeapPosition_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    leap_hand__srv__LeapPosition_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
leap_hand__srv__LeapPosition_Response__Sequence__are_equal(const leap_hand__srv__LeapPosition_Response__Sequence * lhs, const leap_hand__srv__LeapPosition_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!leap_hand__srv__LeapPosition_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  leap_hand__srv__LeapPosition_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(leap_hand__srv__LeapPosition_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    leap_hand__srv__LeapPosition_Response * data =
      (leap_hand__srv__LeapPosition_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!leap_hand__srv__LeapPosition_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          leap_hand__srv__LeapPosition_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!leap_hand__srv__LeapPosition_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
