...
#ifndef LEAP_HAND__SRV__DETAIL__LEAP_VELOCITY__FUNCTIONS_H_
#define LEAP_HAND__SRV__DETAIL__LEAP_VELOCITY__FUNCTIONS_H_
...
/// Initialize srv/LeapVelocity message.
/**
...
/// Finalize srv/LeapVelocity message.
/**
...
/// Create srv/LeapVelocity message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * leap_hand__srv__LeapVelocity_Request__init().
...
/// Destroy srv/LeapVelocity message.
/**
 * It calls
 * leap_hand__srv__LeapVelocity_Request__fini()
...
/// Check for srv/LeapVelocity message equality.
/**
...
/// Copy a srv/LeapVelocity message.
/**
...
/// Initialize array of srv/LeapVelocity messages.
/**
...
/// Finalize array of srv/LeapVelocity messages.
/**
 * It calls
 * leap_hand__srv__LeapVelocity_Request__fini()
...
/// Create array of srv/LeapVelocity messages.
/**
 * It allocates the memory for the array and calls
 * leap_hand__srv__LeapVelocity_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/LeapVelocity messages.
/**
 * It calls
 * leap_hand__srv__LeapVelocity_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/LeapVelocity message array equality.
/**
...
/// Copy an array of srv/LeapVelocity messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * leap_hand__srv__LeapVelocity_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_leap_hand
...
/**
 * It calls
 * leap_hand__srv__LeapVelocity_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_leap_hand
...
/**
 * It allocates the memory for the array and calls
 * leap_hand__srv__LeapVelocity_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_leap_hand
...
/**
 * It calls
 * leap_hand__srv__LeapVelocity_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LEAP_HAND__SRV__DETAIL__LEAP_VELOCITY__FUNCTIONS_H_
